...
const Hero = () => {
    ...
    return (
        <div className='bg-[url(/src/assets/bg.png)] bg-cover bg-no-repeat bg-center w-full h-screen py-16'>
            <div className="flex flex-col items-center justify-center text-white pb-15 max-w-xl mx-auto">
                ...
                <h1 className="font-['Alexandria'] font-bold pb-3 text-5xl md:text-6xl text-center">Escape the Chasm</h1>
