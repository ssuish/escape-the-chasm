    ...
    return (
        <>
            <div className="flex flex-col w-screen h-screen px-[50px] py-[30px] snap-center scroll-smooth bg-linear-to-b from-black to-gray">
                ...
                <div className="grid grid-cols-3 pt-5 h-full w-full items-center justify-items-center ">
                    {devTeam.map((member, index) => (
                        <div key={index} className="flex flex-col items-center justify-center w-[350px] h-[250px] bg-white rounded-lg shadow-lg p-4 text-black 
